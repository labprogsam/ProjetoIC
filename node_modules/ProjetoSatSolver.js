...
function doSolve(clauses, assignment) {
    ...
    for(j = 0; j < clauses.length; j++) { 
        ...
        /* Se a condição abaixo for aceita significa que toda uma clausula não foi
        aceita, logo ele pode pegar o nextAssignment e começar tudo novamente */
...
function readClauses (text) {
  ...
  for(i = 0; i < text.length - position; i++) {
    ...
    //Aqui faço verificações para saber se apos o slit ficou alguns espaços '', e para isso
    //usei um array auxiliar.
    if(arrayClauses[i] != '') {
...
function readVariables (clauses) {
    ...
    //BubbleSort para organizar o meu arrayOrganizado em ordem crescente.
    ...
    //Apos organizado eu pego último (que é o maior) elemento do arrayOrganizado.
...
function fim(assignment) {
    ...
    /* Nessa função eu verifico se eu já cheguei na minha ultima possibilidade*/
